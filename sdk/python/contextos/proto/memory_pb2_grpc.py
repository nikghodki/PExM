...
class MemoryServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.StoreMemory = channel.unary_unary(
                '/contextos.memory.v1.MemoryService/StoreMemory',
        ...
        self.GetMemory = channel.unary_unary(
                '/contextos.memory.v1.MemoryService/GetMemory',
        ...
        self.SearchMemory = channel.unary_unary(
                '/contextos.memory.v1.MemoryService/SearchMemory',
        ...
        self.PromoteMemory = channel.unary_unary(
                '/contextos.memory.v1.MemoryService/PromoteMemory',
                request_serializer=memory__pb2.PromoteMemoryRequest.SerializeToString,
                response_deserializer=memory__pb2.PromoteMemoryResponse.FromString,
                _registered_method=True)
        self.DeleteMemory = channel.unary_unary(
                '/contextos.memory.v1.MemoryService/DeleteMemory',
        ...
        self.ListMemories = channel.unary_unary(
                '/contextos.memory.v1.MemoryService/ListMemories',
...
def add_MemoryServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'PromoteMemory': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=memory__pb2.PromoteMemoryRequest.FromString,
                    response_serializer=memory__pb2.PromoteMemoryResponse.SerializeToString,
            ),
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'contextos.memory.v1.MemoryService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('contextos.memory.v1.MemoryService', rpc_method_handlers)
...
class MemoryService(object):
    ...
    def PromoteMemory(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/contextos.memory.v1.MemoryService/PromoteMemory',
            memory__pb2.PromoteMemoryRequest.SerializeToString,
            memory__pb2.PromoteMemoryResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
